        ...
        <div>
          ...
          >
            <a
              ...
              onClick={() => {
                trackMetaLead();
                trackCtaClick('Hero — Get a free mockup');
              }}
              style={{ padding: '14px 26px', fontSize: 16, fontWeight: 600 }}
              aria-label="Get a free mockup in 48 hours"
            >
              ...
              <svg className="cta-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M5 12h14" />
            ...
            <a
              ...
              aria-label="Chat with us on WhatsApp — replies usually under an hour"
            >
              ...
              Chat on WhatsApp
              <span className="cta-live-dot" aria-hidden="true" style={{ marginLeft: 4 }} />
            </a>
          </div>
          <div
            className="hero-cta-meta"
            style={{
              marginTop: 12,
              display: 'flex',
              gap: 18,
