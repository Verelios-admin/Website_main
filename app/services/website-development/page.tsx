  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A simple business website with five pages starts at ₹49,999. A more involved site — custom CMS, multilingual content, complex search or online payments — typically lands between ₹1,00,000 and ₹3,00,000. What moves a project between those two figures is scope rather than page count: bespoke design work, third-party integrations, payment gateways, and anything that needs its own admin interface behind it. The base tier is not a stripped-back template — it covers mobile-responsive design, a contact form wired to WhatsApp, SEO setup, and help getting your domain and hosting configured. We quote each project after a 15-minute scoping call, and that quote is fixed in writing before any work begins rather than billed by the hour, so the figure you approve is the figure you pay. There is nothing to pay upfront: payment runs in three milestones of 30/30/40 as the work lands.',
      },
    },
    {
      '@type': 'Question',
        ...
        <section className="tile" style={{ paddingTop: 24, paddingBottom: 64 }}>
          <div className="wrap" style={{ maxWidth: 820, margin: '0 auto' }}>
            <Prose>
              ...
              <p>
                A simple business website with five pages starts at <strong>₹49,999</strong>. A more involved site — custom CMS, multilingual content, complex search or online payments — typically lands between <strong>₹1,00,000 and ₹3,00,000</strong>. What moves a project between those two figures is scope rather than page count: bespoke design work, third-party integrations, payment gateways, and anything that needs its own admin interface behind it. The base tier is not a stripped-back template — it covers mobile-responsive design, a contact form wired to WhatsApp, SEO setup, and help getting your domain and hosting configured. We quote each project after a 15-minute scoping call, and that quote is fixed in writing before any work begins rather than billed by the hour, so the figure you approve is the figure you pay. There is nothing to pay upfront: payment runs in three milestones of 30/30/40 as the work lands.
              </p>
